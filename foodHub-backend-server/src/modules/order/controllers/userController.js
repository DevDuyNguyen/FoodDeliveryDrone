...
const Account = require("../../accesscontrol/models/account").default;
const Order = require("../models/order");
const io = require("../../../util/socket").default;
...
const {getIO}=require("../../../util/socket").default;
        ...
        Seller.findById(seller).then(async (seller) => {
          ...
          const order = new Order({
            user: {
              ...
              address: result.address.toObject(),
              userId: result,
            },
            items: items,
            status: "Placed",
